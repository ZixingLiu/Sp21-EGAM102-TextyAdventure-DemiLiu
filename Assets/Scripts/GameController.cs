...
public class GameController : MonoBehaviour
{
    ...
    public enum Location { Hill, City, Space, Cave, Main};
    ...
    void Update()
    {
       ...
       //Did the player press return? If so, look at the input text, and do what needs doing.
        if (Input.GetKeyDown(KeyCode.Return))
        {
            ...
            inputWords = InputText.text.Split(spaceCharacter);
            ...
            else if(CurrentLocation == Location.Main)
            {
                DoMainStuff();
            }
            else if(CurrentLocation == Location.Hill)
            {
                DoHillStuff();
            }
            else if(CurrentLocation == Location.Space)
            {
                DoSpaceStuff();
            }
            ...
            else if(CurrentLocation == Location.City)
            {
                DoCityStuff();
            }
    ...
    void DoMainStuff()
    {
        if (inputWords[0] == "get")
        {
            ...
            if (inputWords[1] == "fish" && inputWords[2] == "net" && SceneInventory.Contains("fishNet"))
            {
        ...
        else if (inputWords[0] == "wear")
        {
            ...
            if (inputWords[1] == "waders" && PlayerInventory.Contains("waders"))
            {
    ...
    void DoHillStuff()
    {
        if(inputWords[0] == "get")
        {
            if(inputWords[1] == "lantern")
            {
                PlayerInventory.Add("lantern");
                SceneInventory.Remove("lantern");
                GameObject.Find("Lantern").GetComponent<SpriteRenderer>().enabled = false;
                OutputText.text += "You pick up the lantern \n ";
                Invoke("MoveScrollbarToBottom", 0.1f);
            }
            else
            {
    ...
    void DoCaveStuff()
    {
        ...
        if(inputWords[0] == "use")
        {
            ...
            else if(inputWords[1] == "key" && PlayerInventory.Contains("key") && SceneInventory.Contains("treasure box"))
            {
                ...
                GameObject.Find("Coin2").GetComponent<SpriteRenderer>().enabled = true;
                GameObject.Find("Coin3").GetComponent<SpriteRenderer>().enabled = true;
        ...
        {
            if(inputWords[1] == "coins" && SceneInventory.Contains("coins"))
            {
